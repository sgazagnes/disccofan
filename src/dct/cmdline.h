...
struct gengetopt_args_info
{
  ...
  int* dims_arg;	/**< @brief Dimensions to be specified comma separated.  */
  char ** dims_orig;	/**< @brief Dimensions to be specified comma separated original value given at command line.  */
  unsigned int dims_min; /**< @brief Dimensions to be specified comma separated's minimum occurreces */
  unsigned int dims_max; /**< @brief Dimensions to be specified comma separated's maximum occurreces */
  const char *dims_help; /**< @brief Dimensions to be specified comma separated help description.  */
  ...
  char * refine_arg;	/**< @brief Transform the data in 16-bit per pixel if original range is higher.  */
  ...
  int segment_arg;	/**< @brief Create binary data, either with threshold dfined by lims options, or with kmeans algor (initial centers can be defined with lims) (default='0').  */
  char * segment_orig;	/**< @brief Create binary data, either with threshold dfined by lims options, or with kmeans algor (initial centers can be defined with lims) original value given at command line.  */
  const char *segment_help; /**< @brief Create binary data, either with threshold dfined by lims options, or with kmeans algor (initial centers can be defined with lims) help description.  */
  ...
  char * density_arg;	/**< @brief Name of density field.  */
  char * density_orig;	/**< @brief Name of density field original value given at command line.  */
  const char *density_help; /**< @brief Name of density field help description.  */
  int periodic_arg;	/**< @brief If data periodic (only with single thread and single MPI (default='0').  */
  char * periodic_orig;	/**< @brief If data periodic (only with single thread and single MPI original value given at command line.  */
  const char *periodic_help; /**< @brief If data periodic (only with single thread and single MPI help description.  */
  float* lims_arg;	/**< @brief Limits.  */
  char ** lims_orig;	/**< @brief Limits original value given at command line.  */
  unsigned int lims_min; /**< @brief Limits's minimum occurreces */
  unsigned int lims_max; /**< @brief Limits's maximum occurreces */
  const char *lims_help; /**< @brief Limits help description.  */
  char * eor_arg;	/**< @brief Eor Type data.  */
  char * eor_orig;	/**< @brief Eor Type data original value given at command line.  */
  const char *eor_help; /**< @brief Eor Type data help description.  */
  int nlev_arg;	/**< @brief Levels for refinement (default='100').  */
  char * nlev_orig;	/**< @brief Levels for refinement original value given at command line.  */
  const char *nlev_help; /**< @brief Levels for refinement help description.  */
  ...
  unsigned int dims_given ;	/**< @brief Whether dims was given.  */
  unsigned int bpp_given ;	/**< @brief Whether bpp was given.  */
  unsigned int refine_given ;	/**< @brief Whether refine was given.  */
  unsigned int segment_given ;	/**< @brief Whether segment was given.  */
  ...
  unsigned int lims_given ;	/**< @brief Whether lims was given.  */
  unsigned int eor_given ;	/**< @brief Whether eor was given.  */
  unsigned int nlev_given ;	/**< @brief Whether nlev was given.  */
